import { defineComponent, useCssVars, unref, ref, onMounted, watch, computed, resolveComponent, resolveDirective, openBlock, createElementBlock, Fragment, withDirectives, createBlock, mergeProps, withCtx, renderList, createVNode, createElementVNode, withModifiers, renderSlot, toDisplayString, resolveDynamicComponent, createCommentVNode, isRef } from "vue";
const toLine = (value) => {
...
var index_vue_vue_type_style_index_0_scoped_true_lang = /* @__PURE__ */ (() => ".edit[data-v-2579e8dc]{width:1rem;height:1rem;position:relative;top:2px;left:4px;cursor:pointer}.icons[data-v-2579e8dc]{display:flex;align-items:center}.icons svg[data-v-2579e8dc]{width:1rem;height:1rem;margin-left:8px;cursor:pointer}.icons .check[data-v-2579e8dc]{color:#67c23a}.icons .close[data-v-2579e8dc]{color:#f56c6c}.pagination[data-v-2579e8dc]{display:flex;align-items:center;margin-top:16px;justify-content:var(--5a9a165c)}\n")();
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: emits }) {
    const props = __props;
    useCssVars((_ctx) => ({
      "5a9a165c": unref(paginationAlignJustify)
    }));
    let currentEdit = ref("");
    const tableData = ref(lodash.exports.cloneDeep(props.data));
    let cloneEditRowIndex = ref(lodash.exports.cloneDeep(props.editRowIndex));
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        withDirectives((openBlock(), createBlock(_component_el_table, mergeProps(_ctx.$attrs, {
          ...
          _: 3
        }, 16, ["element-loading-text", "element-loading-spinner", "data"])), [
          [_directive_loading, unref(isLoading)]
        ]),
        __props.pagination ? (openBlock(), createElementBlock("div", _hoisted_5, [
          createVNode(_component_el_pagination, {
            currentPage: unref(currentPage),
            "onUpdate:currentPage": _cache[0] || (_cache[0] = ($event) => isRef(currentPage) ? currentPage.value = $event : currentPage = $event),
...
var table = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2579e8dc"]]);
var index = {
  install(app) {
