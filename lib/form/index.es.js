import { defineComponent, ref, onMounted, nextTick, watch, resolveComponent, openBlock, createBlock, mergeProps, withCtx, createElementBlock, Fragment, renderList, resolveDynamicComponent, createCommentVNode, renderSlot, createVNode } from "vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose, emit: emits }) {
    ...
    return (_ctx, _cache) => {
      ...
      return model.value ? (openBlock(), createBlock(_component_el_form, mergeProps({
        key: 0,
        ref_key: "form",
        ref: form,
              ...
              !item.children || !item.children.length ? (openBlock(), createBlock(_component_el_form_item, {
                ...
                default: withCtx(() => [
                  item.type !== "upload" && item.type !== "editor" ? (openBlock(), createBlock(resolveDynamicComponent(`el-${item.type}`), mergeProps({
                    ...
                    "onUpdate:modelValue": ($event) => model.value[item.prop] = $event
                  ...
                  item.type === "upload" ? (openBlock(), createBlock(_component_el_upload, mergeProps({ key: 1 }, item.uploadAttrs, {
                    ...
                    _: 2
                  }, 1040, ["http-request"])) : createCommentVNode("", true),
