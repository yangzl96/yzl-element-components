...
var index_vue_vue_type_style_index_0_scoped_true_lang = /* @__PURE__ */ (() => ".result[data-v-7d3eaf82]{display:flex;align-items:center;width:fit-content;cursor:pointer}svg[data-v-7d3eaf82]{width:1rem;height:1rem;transition:all .25s}.rotate[data-v-7d3eaf82]{transform:rotate(180deg)}.container[data-v-7d3eaf82]{padding:6px}.city[data-v-7d3eaf82],.province[data-v-7d3eaf82]{display:flex;align-items:center;flex-wrap:wrap;margin-top:10px;margin-bottom:10px}.city-item[data-v-7d3eaf82],.province-item[data-v-7d3eaf82]{padding:3px 6px;margin-right:8px;border:1px solid #eee;margin-bottom:8px;cursor:pointer}.city-name[data-v-7d3eaf82],.province-name[data-v-7d3eaf82]{display:flex;align-items:center;flex-wrap:wrap}.city-name .city-name-item[data-v-7d3eaf82],.city-name .province-name-item[data-v-7d3eaf82],.province-name .city-name-item[data-v-7d3eaf82],.province-name .province-name-item[data-v-7d3eaf82]{margin-right:6px;margin-bottom:6px;cursor:pointer}\n")();
...
const _hoisted_2 = { style: { "margin-right": "3px" } };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: emits }) {
    ...
    const changeSelect = (val) => {
      const item = allCity.value.find((item2) => item2.id === val);
      result.value = item.name;
      if (radioValue.value === "\u6309\u57CE\u5E02") {
        emits("changeCity", item);
      } else {
      ...
      return openBlock(), createBlock(_component_el_popover, {
        ...
        reference: withCtx(() => [
          createElementVNode("div", _hoisted_1, [
            createElementVNode("div", _hoisted_2, toDisplayString(unref(result)), 1),
              ...
              createElementVNode("div", _hoisted_7, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(Object.keys(provinces.value), (item, index2) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    key: index2,
                    onClick: ($event) => clickChart(item)
                  }, toDisplayString(item), 9, _hoisted_8);
                }), 128))
              ]),
              createVNode(_component_el_scrollbar, { "max-height": "300px" }, {
                default: withCtx(() => [
...
var chooseCity = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7d3eaf82"]]);
var index = {
  install(app) {
