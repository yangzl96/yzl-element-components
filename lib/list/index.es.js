...
var index_vue_vue_type_style_index_0_scoped_true_lang = /* @__PURE__ */ (() => ".container[data-v-7e444a1a]{display:flex;align-items:center;padding:12px 20px;cursor:pointer}.container[data-v-7e444a1a]:hover{background:#e6f6ff}.container .avatar[data-v-7e444a1a]{flex:1}.container .content[data-v-7e444a1a]{flex:3}.container .content .title[data-v-7e444a1a]{display:flex;align-items:center;justify-content:space-between}.container .content .time[data-v-7e444a1a]{font-size:12px;color:#999;margin-top:4px}.actions[data-v-7e444a1a]{height:50px;display:flex;align-items:center;border-top:1px solid #eee}.actions .a-item[data-v-7e444a1a]{height:50px;flex:1;display:flex;align-items:center;justify-content:center;cursor:pointer}.actions .a-item .a-icon[data-v-7e444a1a]{margin-right:4px;position:relative;top:2px}.border[data-v-7e444a1a]{border-right:1px solid #eee}\n")();
...
const _hoisted_1 = { class: "list_tabs__item" };
                      ...
                      createElementVNode("div", _hoisted_8, [
                        (openBlock(true), createElementBlock(Fragment, null, renderList(__props.actions, (action, i) => {
                          return openBlock(), createElementBlock("div", {
                            ...
                            key: i,
                            onClick: ($event) => clickAction(action, i)
                          }, [
...
var list = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7e444a1a"]]);
var index = {
  install(app) {
